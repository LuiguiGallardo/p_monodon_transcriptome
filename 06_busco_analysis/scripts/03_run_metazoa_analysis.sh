...
# This evaluates assembly completeness using metazoan orthologs for broader comparison
# Database: metazoa_odb10 (all animals)

# Configuration
TRANSCRIPTOME="/home/luigui/Documents/2026/p_monodon_transcriptome/05_multiple_group_clustering/Trinity.fasta"
OUTPUT_DIR="../results"
LINEAGE="metazoa_odb10"      # Metazoa database for broader comparison
...
echo "Database: Metazoa (Broader Comparison)"
echo "=========================================="
...
if [ $? -eq 0 ]; then
    ...
    echo "=========================================="
    echo ""
    echo "Results location: ${OUTPUT_DIR}/metazoa_odb10"
    echo ""
    ...
    echo "  cat ${OUTPUT_DIR}/metazoa_odb10/short_summary.*.txt"
else
    echo ""
    echo "ERROR: BUSCO analysis failed"
    echo "Check the log files in ${OUTPUT_DIR}/metazoa_odb10/logs/"
    exit 1
fi
