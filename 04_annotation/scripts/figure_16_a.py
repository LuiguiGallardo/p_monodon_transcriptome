#!/usr/bin/env python3
"""figure_16_a – Functional categories PmSTAT (EggNOG_Function), reads CSV"""
...
if __name__ == '__main__':
    ...
    funcs = {}
    for func in pm['EggNOG_Function'].dropna():
    ...
    bars = ax.barh(y, counts, color='#FF6B6B', edgecolor='black', linewidth=1.2)
    ax.set_yticks(y); ax.set_yticklabels(names, fontsize=9)
    ax.set_xlabel('Number of Proteins', fontsize=11, fontweight='bold')
    ax.set_title('Functional Categories – PmSTAT dsRNA+WSSV', fontsize=13, fontweight='bold')
