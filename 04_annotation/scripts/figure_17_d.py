#!/usr/bin/env python3
"""figure_17_d – Immune & defense pathway WSSV, reads CSV"""
...
if __name__ == '__main__':
    ...
    cat_counts = [(cat, sum(ws_p.get(c, 0) for c in IMMUNE[cat])) for cat in IMMUNE.keys()]
    ...
    ax.set_title('Immune & Defense Pathways – WSSV', fontsize=11, fontweight='bold')
