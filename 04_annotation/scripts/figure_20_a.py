#!/usr/bin/env python3
"""figure_20_a – Top eggNOG functions PmSTAT (reads xlsx)"""
...
if __name__ == '__main__':
    ...
    pm_f = count_funcs(pm)
    top = sorted(pm_f.items(), key=lambda x: x[1], reverse=True)[:10]
    ...
    ax.set_title('Top eggNOG Functions – PmSTAT dsRNA+WSSV', fontsize=13, fontweight='bold')
