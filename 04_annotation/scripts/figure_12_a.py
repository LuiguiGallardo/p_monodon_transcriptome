...
if __name__ == '__main__':
    ...
    b1 = ax.bar(x - w/2, pm_counts, w, label='PmSTAT dsRNA+WSSV', color='blue', edgecolor='black', linewidth=1.2)
    b2 = ax.bar(x + w/2, ws_counts, w, label='WSSV',              color='red', edgecolor='black', linewidth=1.2)
    for bars in [b1, b2]:
        for bar in bars:
            h = bar.get_height()
