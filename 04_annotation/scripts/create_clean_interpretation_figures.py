#!/usr/bin/env python3
"""
Clean interpretation figures without interpretation panels
Figures 4, 5, 6 - compact 3-panel layouts
"""
...
def create_clean_figures():
    """Create clean figures without interpretation panels"""
    
    print("Cooking up clean interpretation figures (no interpretation panels)...\n")
    
    # ========== FIGURE 4: KEGG Pathway Enrichment (3 panels) ==========
    ...
    # ========== FIGURE 5: Functional Category Analysis (3 panels) ==========
    print("  → Figure 5: Functional Categories Analysis")
    fig = plt.figure(figsize=(18, 10))
    gs = fig.add_gridspec(1, 3, hspace=0.3, wspace=0.35)
    
    # Panel A: PmSTAT functional categories
    ax_a = fig.add_subplot(gs[0, 0])
    pmstat_funcs = {}
    ...
    # Panel B: WSSV functional categories
    ax_b = fig.add_subplot(gs[0, 1])
    wssv_funcs = {}
    ...
    # Panel C: Shared functional categories
    ax_c = fig.add_subplot(gs[0, 2])
    
    common_funcs = list((set(pmstat_funcs.keys()) & set(wssv_funcs.keys())))[:10]
    if common_funcs:
    ...
    plt.suptitle('Figure 5: Functional Category Analysis', 
                 fontsize=15, fontweight='bold', y=0.98)
    ...
    # ========== FIGURE 6: Immune Response Pathways (3 panels) ==========
    ...
    plt.suptitle('Figure 6: Immune & Stress Response Pathways', 
                 fontsize=15, fontweight='bold', y=0.98)
    ...
    print("\n✓ Boom! All clean figures generated successfully!")
    print(f"  Saved to: only_differential_expression_proteins/")

if __name__ == '__main__':
    create_clean_figures()
